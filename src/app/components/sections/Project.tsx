...
const Projects: React.FC = () => {
    ...
    //                 </p>
    //                 <div className="box-card-timeline bg-amber-300">
    ...
    //                                 width={500}
    //                                 height={500}
    //                                 className="card-timeline w-full h-full object-cover"
    //                             />
    //                         </AnimatedCard>
    //                     </div>
    //                     <div className="h-full w-full overflow-hidden rounded-lg">
    ...
    //                         <div className="h-full w-full overflow-hidden rounded-lg"> {/* Image 1 */}
    ...
    //                     </div>
    //                     <div className="h-full w-full overflow-hidden rounded-lg"> <AnimatedCard index={0}><img
    ...
    //                 </p>
    //                 <div className="box-card-timeline">
    //                     <div className="h-full w-full overflow-hidden rounded-lg"> <AnimatedCard index={0}><video
